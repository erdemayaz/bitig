...
- **`analyze:init`**: Creates a custom scoring schema (`quality-guidelines.json`) where editors can define evaluation criteria (Accuracy, Progression, Transitions, Readability, Completeness, Consistency, Intelligibility) and assign fractional weights.
